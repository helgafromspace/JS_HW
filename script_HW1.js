...
!!'false' == !!'true'
// результат - true; завдяки оператору !! зліва від == відбувається перетворення: перша логічна інверсія (перший !) - строка 'false' є true(бо вона не порожня), тому логічне НЕ дає булеве false, друга логічна інверсія (друге !) - false стає true; зправа від == те саме; відповідно, true == true дає true
